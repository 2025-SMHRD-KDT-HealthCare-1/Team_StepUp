...
// 🔹 백엔드 서버 주소 (Logs.jsx와 맞춰서 5000번 포트로 통일)
...
export default function Pose() {
  ...
  const handleStopAnalysis = () => {
    ...
    // pushup.html 쪽에서 이 메시지 받아서
    // 녹화 중지 + 업로드 후 STEPUP_VIDEO_UPLOADED 보내도록 구현
    iframeWindow.postMessage(
      {
